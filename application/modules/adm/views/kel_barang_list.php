  <div class="accordion">
 <h3 href="<?php echo base_url()?>index.php/adm/gridr/ms_subkelompok_barang">SUB KELOMPOK BARANG</h3>
            <div>
			...
			<p>	
				<label>
					<select id="myfield" >
						<option value="KODE_SUBKELOMPOK" >Kode Sub Kelompok</option>
						<option value="NAMA_SUBKELOMPOK" >Nama Sub Kelompok</option>
					</select>
				</label>
 ...
 <script>
  ...
  $(document).ready(function(){
	...
	$("#btnSrc").click(function() {
		...
		var grid = $("#grid_ms_subkelompok_barang");
