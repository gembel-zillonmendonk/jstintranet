...
class Ep_kom_harga_barang extends MY_Model {
    ...
    public $sql_select = "(select   H.KODE_HARGA_BARANG , H.KODE_BARANG ,  J.NAMA_BARANG , J.KODE_SUB_BARANG, 
	H.KODE_KANTOR ,  H.KODE_SUMBER , S.NAMA_SUMBER ,  H.TGL_SUMBER ,  H.MATA_UANG ,  H.HARGA ,  H.KODE_VENDOR 
        ,  CASE 
