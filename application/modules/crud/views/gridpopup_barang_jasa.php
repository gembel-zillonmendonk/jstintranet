    ...
    jQuery(document).ready(function ($) {
        ...
        jQuery('#<?php echo $grid->id ?>').jqGrid({
			...
			"onSelectRow": function(ids) { 
				var selected = $('#grid_kom_barang_jasa').jqGrid('getGridParam', 'selrow');
				 selected = jQuery('#grid_kom_barang_jasa').jqGrid('getRowData',selected);
			 
				 arr_barangjasa = new Array(); 
                                 arr_barangjasa[0] = selected["KODE_BARANG"];
                                 arr_barangjasa[1] = selected["KODE_SUB_BARANG"];
                                 arr_barangjasa[2] = selected["NAMA_BARANG"];
                                 
                                 
				 fnBarangJasa(arr_barangjasa  );
			},
