    ...
    jQuery(document).ready(function ($) {
        ...
        jQuery('#<?php echo $grid->id ?>').jqGrid({
			...
			"onSelectRow": function(ids) { 
				var selected = $('#grid_ep_pgd_perencanaan').jqGrid('getGridParam', 'selrow');
				 selected = jQuery('#grid_ep_pgd_perencanaan').jqGrid('getRowData',selected);
			 
                                 var arr_param = new Array(); 
                                 
                                 arr_param[0] = selected["KODE_PERENCANAAN"];
                                 arr_param[1] = selected["KODE_KANTOR"];
                                 arr_param[2] = selected["JUDUL_PEKERJAAN"];
                                 arr_param[3] = selected["LINGKUP_PEKERJAAN"];
                                
                                  
                                  fnPerencanaan(arr_param);
				  /*
