    ...
    jQuery(document).ready(function ($) {
        ...
        jQuery('#<?php echo $grid->id ?>').jqGrid({
			...
			"onSelectRow": function(ids) { 
				var selected = $('#grid_ms_barang').jqGrid('getGridParam', 'selrow');
				 selected = jQuery('#grid_ms_barang').jqGrid('getRowData',selected);
			 
				 
				 fnSetValue(selected["KODE_BARANG"], selected["KODE_SUB_BARANG"] , selected["NAMA_BARANG"]   );
			},
