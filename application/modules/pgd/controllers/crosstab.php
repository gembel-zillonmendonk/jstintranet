...
/* EXAMPLES USING MS NORTHWIND DATABASE */
    ...
    function pivot_sql(){
        ...
        $sql =   $this->PivotTableSQL($this->db, "EP_PGD_ITEM_PENAWARAN P, EP_VENDOR V, (SELECT KODE_JASA AS KODE_BARANG_JASA , KODE_KEL_JASA AS  KODE_SUB_BARANG_JASA, NAMA_JASA AS NAMA_BARANG_JASA
FROM EP_KOM_JASA
UNION ALL
SELECT KODE_BARANG, KODE_SUB_BARANG, NAMA_BARANG
FROM MS_BARANG) J ", "P.KODE_BARANG_JASA, J.NAMA_BARANG_JASA ", "NAMA_VENDOR", "P.KODE_VENDOR = V.KODE_VENDOR AND P.KODE_BARANG_JASA =  J.KODE_BARANG_JASA AND P.KODE_SUB_BARANG_JASA =  J.KODE_SUB_BARANG_JASA ",  "P.HARGA","SUM");
