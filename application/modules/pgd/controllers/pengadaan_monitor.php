...
class Pengadaan_monitor extends MY_Controller {
	...
	function index() {
        ...
        function header() {
                ...
                $sql = "SELECT T.KODE_TENDER, T.JUDUL_PEKERJAAN, T.LINGKUP_PEKERJAAN, T.TIPE_KONTRAK, K.NAMA_KANTOR, T.NAMA_PEMOHON, K1.NAMA_KANTOR AS NAMA_KANTOR_KIRIM  ";
                ...
                if (count($result)) {
                    ...
                    $data["nomor_pengadaan"] = $result[0]->KODE_TENDER;
        ...
        function metode_pengadaan() {
            ...
            $sql .= " LEFT JOIN EP_MS_KELOMPOK_PANITIA KP ON P.KODE_PANITIA = KP.KODE_PANITIA AND P.KODE_KANTOR_PANITIA = KP.KODE_KANTOR  ";
        ...
        function metode_jadwal() {
            $sql = "SELECT P.METODE_TENDER,M.NAMA_METODE_TENDER,  P.METODE_SAMPUL, S.NAMA_METODE_SAMPUL , P.KODE_EVALUASI, P.KETERANGAN_EVALUASI ";
            $sql .= " , P.TGL_PEMBUKAAN_REG, P.TGL_PENUTUPAN_REG, P.TGL_PRE_LELANG, P.LOKASI_PRE_LELANG, P.TGL_PEMBUKAAN_LELANG, P.PTP_INQUIRY_NOTES, P.TGL_MULAI_PENAWARAN ";
            $sql .= " , KP.NAMA_PANITIA ";
            $sql .= " FROM EP_PGD_PERSIAPAN_TENDER P "; 
            $sql .= " LEFT JOIN EP_PGD_METODE M ON P.METODE_TENDER = M.METODE_TENDER ";
            $sql .= " LEFT JOIN EP_PGD_SAMPUL S ON P.METODE_SAMPUL = S.METODE_SAMPUL ";
        ...
        function jadwal() {
            ...
            if (count($result)) {
             ...
             $this->load->view("pengadaan_monitor_jadwal", $data);         
