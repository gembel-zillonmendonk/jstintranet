...
class Ep_pgd_perencanaan extends MY_Model {
    ...
    public $sql_select = "(SELECT P.PERENCANA, P.KODE_PERENCANAAN ,  P.KODE_KANTOR, P.JUDUL_PEKERJAAN, P.LINGKUP_PEKERJAAN,  K.NAMA_KANTOR, P.RENCANA_KEBUTUHAN, P.RENCANA_PELAKSANAAN, P.STATUS  
