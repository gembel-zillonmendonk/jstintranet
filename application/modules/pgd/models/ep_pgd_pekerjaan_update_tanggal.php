 ...
 * @author  
 */
class Ep_pgd_pekerjaan_update_tanggal extends MY_Model {
    ...
    public $columns_conf = array('KODE_KOMENTAR' =>array('hidden'=>true, 'width'=>0) 
                        ...
                        ,'PROSES' =>array('hidden'=>false, 'width'=>7,'align'=>'center') 
    ...
    function __construct() {
		...
		for(var i=0;i < ids.length;i++){
                    ...
                    be = "<button onclick=\"fnProsesUpdateTanggal(\'"+cl+"\');\"  >PROSES</button>"; 
