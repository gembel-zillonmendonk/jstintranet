 ...
 * @author  
 */
class Ep_pgd_tender_evaluasi_harga extends MY_Model {
    ...
    public $sql_select = "(SELECT  
							 ...
							 NAMA_VENDOR ,
                                                         ...
                                                         ROWNUM AS PERINGKAT
                                                           ...
                                                           ,  '' as \"BTN_NILAI_HARGA\"
			 			  FROM 	 (SELECT ROWNUM AS PERINGKAT,  KODE_TENDER, KODE_KANTOR , KODE_VENDOR,  NAMA_VENDOR, ADM, NILAI_TEKNIS, PASSING_GRADE, LULUS , NILAI_BOBOT, HARGA, NILAI_HARGA, NILAI_TOTAL
	FROM (
