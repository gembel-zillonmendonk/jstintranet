...
class Ep_pgd_item_tender extends MY_Model {
    ...
    public $sql_select = "( SELECT T.KODE_TENDER, T.KODE_KANTOR ,T.KODE_BARANG_JASA , J.KODE_SUB_BARANG_JASA AS KODE_SUB_BARANG_JASA, T.KETERANGAN,    T.JUMLAH, T.UNIT,TO_CHAR(T.HARGA ,'999G999G999G999') AS HARGA,  T.JUMLAH *  T.HARGA AS SUBTOTAL
                ,  '' as \"EDIT\"
                ,  '' as \"HAPUS\" 
