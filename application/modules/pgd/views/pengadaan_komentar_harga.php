<form id="frmKomentarTeknis" method="POST" action="<?php echo base_url() . "index.php/pgd/pengadaan_evaluasi/komentar_harga/" . $KODE_VENDOR . "/" . $NAMA_VENDOR; ?>"  >
<p>                   
               <textarea  style="width:100%" id="commentar_harga" name="commentar_harga" ></textarea>
</p>
<input type="hidden" id="KOMENTAR_EVALUASI_HARGA" name="KOMENTAR_EVALUASI" value="" />
