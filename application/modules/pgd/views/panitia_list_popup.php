  <div class="accordion">
 <h3 id="h3_panitia_popup" href="<?php echo base_url(); ?>index.php/pgd/gridpopup_panitia/ep_pgd_panitia_view_get">PANITIA</h3>
            <div>
			<p>
			<div id="mysearch"></div>
 ...
 <script>
  ...
  $(document).ready(function(){
	...
	$(".accordion" ).each(function(){
                ...
                $('#h3_panitia_popup', $(this)).each(function(){
                    var uri = $(this).attr('href');
                    if(uri != '' && uri != '#'){
                        var ctn = $("#listpopup_panitia") ;
                        //alert($(ctn).width());
                        //alert(uri);
                        if(ctn.html() == '')
                            ctn.load(uri);
