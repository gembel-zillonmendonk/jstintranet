...
-->
 ...
 <h3 id="InputPembuatanJadwal" href="" >JADWAL PENGADAAN</h3>
    <div>
      <fieldset class="ui-widget-content">
      <form class="clsinput"  id="frm_InputPembuatanJadwal" method="POST" action="<?php echo base_url() . "index.php/pgd/pekerjaan_pgd/update_pembuatan_jadwal"; ?>" > 
          <p>	
 ...
 var validator_InputPembuatanJadwal 
  $(document).ready(function(){
     ...
     $("#btnKembali").click(function(){
        window.location = "<?php echo base_url() ."index.php/pgd/tools"; ?>";
