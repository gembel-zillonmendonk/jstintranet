            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="control-group">
                        <?php echo form_label("PELAKSANA PENGADAAN", "KODE_JAB_PELAKSANA", array("class" => "control-label")) ?> 
                        <div class="controls">
                            <?php
                            echo form_dropdown("KODE_JAB_PELAKSANA", $pelaksana
                                    , isset($_REQUEST['KODE_JAB_PELAKSANA']) ? $_REQUEST['KODE_JAB_PELAKSANA'] : "", 'class="{validate:{required:true,maxlength:22}}"');
                            ?>
                        </div>
                    </div>
                </div>
