...
class list_process extends MY_Model {

    public $table = 'EP_VENDOR';
    public $dir = 'vendor';
    public $sql_select = "( select x.*, y.*, '' as \"ACT\" from (
                                select a.*, e.NAMA as NAMA_WKF,c.NAMA_AKTIFITAS, b.url, d.value as KODE_VENDOR_VALUE 
                                ...
                                inner join EP_WKF e on A.KODE_WKF = e.KODE_WKF
                                inner join EP_WKF_PROSES_VARS d on a.kode_proses = d.kode_proses and d.key = 'KODE_VENDOR'
                                where kode_wkf like '5%' and tanggal_selesai is null
                            ) x
    ...
    function __construct() {
		...
		for(var i=0;i < ids.length;i++){
                    ...
                    var param = "referer_url=/vendor/list_proses&kode_proses=" + data[\'KODE_PROSES\'] + data[\'URL\'];
